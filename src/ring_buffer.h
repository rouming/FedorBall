...
static __inline__ uint32_t ring_buffer_init(struct ring_buffer* rbuf,
...
static __inline__ uint32_t ring_buffer_total_size(const struct ring_buffer* rbuf)
{
	return rbuf->size;
}

/* Returns used size, i.e. size available for read of ring buffer */
static __inline__ uint32_t ring_buffer_used_size(const struct ring_buffer* rbuf)
{
	MEM_BARRIER;
...
static __inline__ uint32_t ring_buffer_free_size(const struct ring_buffer* rbuf)
{
...
static __inline__ uint32_t ring_buffer_write_ptr(const struct ring_buffer* rbuf,
												 uint32_t size,
...
static __inline__ uint32_t ring_buffer_read_ptr(const struct ring_buffer* rbuf,
												uint32_t size,
												void** p1, uint32_t* sz1,
												void** p2, uint32_t* sz2)
{
